...
<body>
    ...
    <header class="header-part"><a href="index.html" class="header-logo"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/logo.png" alt="logo"></a>
        ...
        </div><a href="register.html" class="header-user"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/user.png"
    ...
    <aside class="sidebar-part">
        <div class="sidebar-header"><a href="#"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/logo.png" alt="logo"></a><button
    ...
    <section class="section-gap-95">
        <div class="container">
            ...
            <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 row-cols-xl-5">
                <div class="col"><a class="brand-card" href="inventory-list.html"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/brand/01.png"
                            alt="brand">
                        <h6>tesla</h6>
                        <p>(24) vehicles</p>
                    </a></div>
                <div class="col"><a class="brand-card" href="inventory-list.html"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/brand/02.png"
                            alt="brand">
                        <h6>nissan</h6>
                        <p>(24) vehicles</p>
                    </a></div>
                <div class="col"><a class="brand-card" href="inventory-list.html"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/brand/03.png"
                            alt="brand">
                        <h6>mercedes</h6>
                        <p>(24) vehicles</p>
                    </a></div>
                <div class="col"><a class="brand-card" href="inventory-list.html"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/brand/04.png"
                            alt="brand">
                        <h6>toyota</h6>
                        <p>(24) vehicles</p>
                    </a></div>
                <div class="col"><a class="brand-card" href="inventory-list.html"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/brand/05.png"
                            alt="brand">
                        <h6>audi</h6>
                        <p>(24) vehicles</p>
                    </a></div>
                <div class="col"><a class="brand-card" href="inventory-list.html"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/brand/06.png"
                            alt="brand">
                        <h6>lamborghini</h6>
                        <p>(24) vehicles</p>
                    </a></div>
                <div class="col"><a class="brand-card" href="inventory-list.html"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/brand/07.png"
                            alt="brand">
                        <h6>bugatti</h6>
                        <p>(24) vehicles</p>
                    </a></div>
                <div class="col"><a class="brand-card" href="inventory-list.html"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/brand/08.png"
                            alt="brand">
                        <h6>ferrari</h6>
                        <p>(24) vehicles</p>
                    </a></div>
                <div class="col"><a class="brand-card" href="inventory-list.html"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/brand/09.png"
                            alt="brand">
                        <h6>bmw</h6>
                        <p>(24) vehicles</p>
                    </a></div>
                <div class="col"><a class="brand-card" href="inventory-list.html"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/brand/10.png"
                            alt="brand">
                        <h6>porsche</h6>
                        <p>(24) vehicles</p>
                    </a></div>
                    ...
                    <div class="blog-grid-card">
                        ...
                        <div class="blog-grid-content">
                            ...
                            <p class="blog-grid-descrip">Adipisicing elitelit impedit laborum voluptate ad officia eius
                                veritatis unde modi placeat obcaecati maxime${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets.<a href="blog-single.html">read more</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/vendor/slickslider/ltr-slick-custom.js"></script>
